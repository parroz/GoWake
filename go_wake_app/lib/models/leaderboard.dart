...
class ResultLeaderboard {
  List<Leaderboard> get  leaderboards => results;
  List<Leaderboard> results= [];
  ResultLeaderboard();

  ResultLeaderboard.fromJson(Map<String, dynamic> json) {
    if (json['results'] != null) {
      results = <Leaderboard>[];
      json['results'].forEach((v) {
        results!.add(new Leaderboard.fromJson(v));
      });
    }
  }
...
class Leaderboard {
  ...
  Leaderboard.fromJson(Map<String, dynamic> json) {
    ...
    qPlacement = json['Q_placement'];
    rankingEventFinalPoints = json['ranking_event_final_points'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['Q_placement'] = this.qPlacement;
    data['ranking_event_final_points'] = this.rankingEventFinalPoints;
